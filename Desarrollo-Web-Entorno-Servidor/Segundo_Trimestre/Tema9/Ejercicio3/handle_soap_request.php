...
define('LOCATION_WSDL', 'http://localhost.servidor/Unidad9/Ejercicio3/wsdl/simple_service_definition.wsdl');
define('LOCATION_NO_WSDL', 'http://localhost.servidor/Unidad9/Ejercicio3/no_wsdl/server_endpoint.php');
