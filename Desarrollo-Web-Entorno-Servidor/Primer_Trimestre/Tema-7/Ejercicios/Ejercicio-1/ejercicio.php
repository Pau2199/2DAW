...
<html lang="en">
    ...
    <body>
        <form action="ejercicio.php" method="post">
            <select name="idiomas">
                <option selected="<?= $_COOKIE['idioma'] == 'es' ? 'true' : 'false' ?>" value="es">Catellano</option>
                <option selected="<?= $_COOKIE['idioma'] == 'en' ? 'true' : 'false' ?>" value="en">Ingles</option>
                <option selected="<?= $_COOKIE['idioma'] == 'val' ? 'true' : 'false' ?>" value="val">Valenciano</option>
            </select>
