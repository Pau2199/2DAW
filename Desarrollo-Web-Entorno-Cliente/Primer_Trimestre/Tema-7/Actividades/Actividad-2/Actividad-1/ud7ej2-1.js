...
function cargar(){
    ...
    function tomarDatos(evento){
        ...
        var comentario = {nombre:document.getElementById('nombre').value, email:document.getElementById('mail').value, comentario:document.getElementById('comentario').value};
